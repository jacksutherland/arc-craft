...
class ARC extends Plugin
{
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new ARCTwigExtension());

        $this->setComponents([
            'arcService' => ArcService::class
        ]);
        ...
        Event::on(
            ...
            function (RegisterUrlRulesEvent $event) {
                //$event->rules['cpActionTrigger1'] = 'arc/member/do-something';
            }
        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = ARCUtilityUtility::class;
            }
        );
